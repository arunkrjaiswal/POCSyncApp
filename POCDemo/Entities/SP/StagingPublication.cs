...
{   
    public class StagingPublication : BaseList
    {        
        ...
        public ImageLookup IconImageUrl { get; set; }
        public object SubscriptionUrl { get; set; }
        public object SubscriptionUrlText { get; set; }        
        public object ReplicatedReferenceField { get; set; }        
