...
{   
    public class StagingFeaturedPromotion : BaseList
    {        
        public StringType ContentTypeId { get; set; }        
        public object _ModerationComments { get; set; }
        public object File_x0020_Type { get; set; }
        public ImageLookup FeaturedPromoImage { get; set; }
        public string FeaturedPromoText { get; set; }
        public object FeaturedPromoBackg { get; set; }
        public string BTKeys { get; set; }        
        public string FeaturedPromotionURL { get; set; }       
