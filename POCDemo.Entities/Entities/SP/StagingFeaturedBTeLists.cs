...
{
    public class StagingFeaturedBTeLists : BaseList
    {        
        public StringType ContentTypeId { get; set; }        
        public object _ModerationComments { get; set; }
        public object File_x0020_Type { get; set; }
        public EListLookup BTListCategory { get; set; }
        public EListLookup BTListSubCategory { get; set; }
        public EListLookup BTListName { get; set; }        
